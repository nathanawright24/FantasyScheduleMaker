...
Schedule Structure
WeekType1Rivalry week2–11Non-rival round robin (10 weeks)12Repeat of week 213Repeat of week 314Rivalry week (identical to week 1)
Scheduling Rules

Rivalry weeks (1 and 14) — Every team plays their designated permanent rival. These two weeks are identical to each other.
...
Rival-to-index assignment — The 6 rival pairs are randomly mapped to the 6 index slots (6! orderings), and within each rival pair the two teams are randomly assigned to the two indices (2⁶ swaps). This yields up to 6! × 2⁶ ≈ 46,000 distinct round-robin structures.
Week ordering — Once weeks 2-3 are chosen, the remaining 8 rounds are shuffled and assigned to weeks 4-11 in random order.
...
Key Numbers
MetricValueTeams12Rival pairs6Total possible pairs (C(12,2))66Non-rival pairs60Pairs needed for round robin (10 × 6)60Distinct round-robin structures sampled~46,000Round-robin attempts per run (max)2,000
